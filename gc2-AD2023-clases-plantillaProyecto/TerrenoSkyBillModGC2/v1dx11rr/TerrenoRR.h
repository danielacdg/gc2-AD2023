...
public:
	TerrenoRR(int ancho, int alto, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext)
	{
		...
		CargaParametros(L"GrassTexture_Albedo.png", L"GC2_HeightMap.jpg", 100.0f);
	}
	...
	bool CargaParametros(WCHAR* diffuseTex, WCHAR* heightTex, float tile)
	{
		...
		d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice, L"DirtRoadsTexture_Albedo.png", 0, 0, &colorMap2, 0 );
		d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice, L"GC2_BlendMap.jpg", 0, 0, &blendMap, 0 );
