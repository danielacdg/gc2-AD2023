...
public:
	TerrenoRR(int ancho, int alto, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext)
	{
		...
		CargaParametros(L"imagenes/tierra.jpg", L"imagenes/hm1.jpg", 100.0f);
	}
	...
	bool CargaParametros(WCHAR* diffuseTex, WCHAR* heightTex, float tile)
	{
		...
		d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice, L"imagenes/hierba2.jpg", 0, 0, &colorMap2, 0 );
		d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice, L"imagenes/hm1b.jpg", 0, 0, &blendMap, 0 );
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"imagenes/polvo.jpg", 0, 0, &colorMap3, 0);
