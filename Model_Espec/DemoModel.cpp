...
bool CDemoModel::LoadContent()
{
    ...
    hr = ::D3DX11CreateShaderResourceViewFromFile(
        m_pD3DDevice, L"Recursos/azulejo2.png", 0, 0, &m_pColorMap, 0);
    if (FAILED(hr)) {
    ...
    //-- Load BumpMap
    hr = ::D3DX11CreateShaderResourceViewFromFile(
        m_pD3DDevice, L"Recursos/azulejo2_bump.png", 0, 0, &m_pBumpMap, 0);
    if (FAILED(hr)) {
    ...
    //-- Load BumpMap
    //hr = ::D3DX11CreateShaderResourceViewFromFile(
      //  m_pD3DDevice, L"Recursos/azulejo_bump.jpg", 0, 0, &m_pBumpMap, 0);
    //if (FAILED(hr)) {
      //  ::MessageBox(m_hWnd, L"Unable to load bump map", L"ERROR", MB_OK);
      //  return false;
    //}
    ...
    // Load SpecularMap
    hr = ::D3DX11CreateShaderResourceViewFromFile(
        m_pD3DDevice, L"Recursos/azulejo2_spec.png", 0, 0, &m_pSpecularMap, 0);
    if (FAILED(hr)) {
        ::MessageBox(m_hWnd, L"Unable to load bump map", L"ERROR", MB_OK);
        return false;
    }
