...
PS_Input VS_Main(VS_Input vertex)
{
    ...
    // Set light position
    float3 lightPos = float3(10.0f, 14.0f, -100.0f); //10.0f, 100.0f, -100.0f
...
float4 PS_Main(PS_Input frag) : SV_TARGET
{
    ...
    // Diffuse color
    float3 diffuseColor = float3(color1R, color1G, color1B);
    float3 diffuseColor2 = float3(color2R, color2G, color2B);
