...
cbuffer cbSpecularIntensity3 : register(b6)
{
...
float4 PS_Main(PS_Input frag) : SV_TARGET
{
    ...
    float3 diffuseColor = float3(0.9f, 0.3f, 0.3f); // Rosa claro

    // ---------- Color de la Luz Especular
    float3 specularColor = float3(specularIntensity2, specularIntensity3, 0.5f);
