...
CDemoModel::CDemoModel(float specular)
{
    ...
    m_Light = XMFLOAT3(0.0f, 0.0f, 5.5f);
    m_LightPos = m_Light;
...
void CDemoModel::Render()
{
    ...
    m_pD3DContext->VSSetConstantBuffers(5, 1, &m_pSpecularIntensity);
    m_pD3DContext->VSSetConstantBuffers(6, 1, &m_pSpecularIntensity2);
