...
public:	
    ...
    DXRR(HWND hWnd, int Ancho, int Alto)
	{
		...
		gema1 = new ModeloRR(d3dDevice, d3dContext, "Assets/Gema/emerald.obj", L"Assets/Gema/emerald.jpg", L"Assets/Gema/emerald.jpg", 0, 0);
		gema2 = new ModeloRR(d3dDevice, d3dContext, "Assets/Gema/emerald.obj", L"Assets/Gema/emerald.jpg", L"Assets/Gema/emerald.jpg", 0, 0);
		gema3 = new ModeloRR(d3dDevice, d3dContext, "Assets/Gema/emerald.obj", L"Assets/Gema/emerald.jpg", L"Assets/Gema/emerald.jpg", 0, 0);
		gema4 = new ModeloRR(d3dDevice, d3dContext, "Assets/Gema/emerald.obj", L"Assets/Gema/emerald.jpg", L"Assets/Gema/emerald.jpg", 0, 0);
		gema5 = new ModeloRR(d3dDevice, d3dContext, "Assets/Gema/emerald.obj", L"Assets/Gema/emerald.jpg", L"Assets/Gema/emerald.jpg", 0, 0);
		//

		//GUI
		vida = new GUI(d3dDevice, d3dContext, 0.15, 0.26, L"Assets/GUI/health_full.png");
		texto = new Text(d3dDevice, d3dContext, 3.6, 1.2, L"Assets/GUI/font.jpg", XMFLOAT4(0.39f, 0.79f, 0.18f, 1.0f));
	}
	...
	void Render(void)
	{
		...
		if (isPointInsideSphere(camara->getPos(), gema1->getSphere(5))) {
		...
		ss << gemas;
		TurnOnAlphaBlending();
		texto->DrawText(-0.95, 0.88, "Gemas: " + ss.str(), 0.015);
		texto->DrawText(-0.95, 0.95, "Tiempo: " + texto->Time(segundos), 0.015);
		TurnOffAlphaBlending();
