...
bool GraphicsClass::Render(float rotation) {
	...
	D3DXMatrixRotationY(&MercuryMatrix, -rotation * 0.9);
	D3DXMatrixRotationY(&VenusMatrix, -rotation * 0.7);
	D3DXMatrixRotationY(&EarthMatrix, rotation * 0.5);
	...
	D3DXMatrixTranslation(&auxMatrix, 40, 0, 0);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
	...
	D3DXMatrixRotationY(&auxMatrix, -rotation * 0.3);
	D3DXMatrixMultiply(&MartMatrix, &MartMatrix, &auxMatrix);
	...
	D3DXMatrixScaling(&auxMatrix, 1.9, 1.9, 1.9);
	D3DXMatrixMultiply(&EarthMatrix, &EarthMatrix, &auxMatrix);
	...
	result = m_LightShader->Render(m_D3D->GetDeviceContext(), 
		m_Model->GetIndexCount(), SunMatrix, viewMatrix, projectionMatrix, traMatrix,		       
		m_Model->GetTexture(), m_Model->GetTexture2(), m_Light->GetDirection(),
	...
	//
	result = m_LightShader->Render(m_D3D->GetDeviceContext(),
		m_Model->GetIndexCount(), MercuryMatrix, viewMatrix, projectionMatrix, traMatrix,
		m_Model->GetTexture3(), m_Model->GetTexture3(), m_Light->GetDirection(),
		m_Light->GetDiffuseColor());
	...
	//
	result = m_LightShader->Render(m_D3D->GetDeviceContext(),
		m_Model->GetIndexCount(), VenusMatrix, viewMatrix, projectionMatrix, traMatrix,
		m_Model->GetTexture4(), m_Model->GetTexture4(), m_Light->GetDirection(),
		m_Light->GetDiffuseColor());
	...
	//
	result = m_LightShader->Render(m_D3D->GetDeviceContext(),
		m_Model->GetIndexCount(), EarthMatrix, viewMatrix, projectionMatrix, traMatrix,
		m_Model->GetTexture5(), m_Model->GetTexture5(), m_Light->GetDirection(),
		m_Light->GetDiffuseColor());
	...
	//
	result = m_LightShader->Render(m_D3D->GetDeviceContext(),
		m_Model->GetIndexCount(), MoonMatrix, viewMatrix, projectionMatrix, traMatrix,
		m_Model->GetTexture6(), m_Model->GetTexture6(), m_Light->GetDirection(),
		m_Light->GetDiffuseColor());
	...
	//
	result = m_LightShader->Render(m_D3D->GetDeviceContext(),
		m_Model->GetIndexCount(), MartMatrix, viewMatrix, projectionMatrix, traMatrix,
		m_Model->GetTexture7(), m_Model->GetTexture7(), m_Light->GetDirection(),
		m_Light->GetDiffuseColor());
