...
bool GraphicsClass::Render(float rotation){
	...
	D3DXMatrixRotationY(&MercuryMatrix, -rotation);
	D3DXMatrixRotationY(&EarthMatrix, -rotation);

	D3DXMatrixRotationY(&EarthMatrix, -90);

	D3DXMatrixRotationY(&MartMatrix, -rotation);
	D3DXMatrixRotationY(&VenusMatrix, -rotation);
	D3DXMatrixRotationX(&MoonMatrix, -rotation);
	...
	D3DXMatrixTranslation(&auxMatrix, 8, 0, 0);
	D3DXMatrixMultiply(&MartMatrix, &MartMatrix, &auxMatrix);

	D3DXMatrixTranslation(&auxMatrix, 6, 0, 0);
	D3DXMatrixMultiply(&VenusMatrix, &VenusMatrix, &auxMatrix);

	D3DXMatrixTranslation(&auxMatrix, 2, 0, 0);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
	...
	D3DXMatrixRotationY(&auxMatrix, -rotation * 0.2);
	D3DXMatrixMultiply(&VenusMatrix, &VenusMatrix, &auxMatrix);

	D3DXMatrixRotationY(&auxMatrix, -rotation * 0.5);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);

	///mov luna alrededor tierra
