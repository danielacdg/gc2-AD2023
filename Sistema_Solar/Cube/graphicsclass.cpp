...
bool GraphicsClass::Render(float rotation){
	...
	D3DXMATRIX viewMatrix, projectionMatrix, auxMatrix, traMatrix, SunMatrix, EarthMatrix, MartMatrix, MoonMatrix, MercuryMatrix, VenusMatrix;
	...
	D3DXMatrixRotationY(&EarthMatrix, -rotation * 0.6);
	D3DXMatrixRotationY(&MartMatrix, -rotation * 0.3);

	D3DXMatrixRotationY(&MoonMatrix, -rotation * 0.5);

	D3DXMatrixTranslation(&auxMatrix, 3, 0, 0);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);

	D3DXMatrixRotationY(&auxMatrix, -rotation * 1.3);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
	...
	D3DXMatrixMultiply(&MercuryMatrix, &MercuryMatrix, &auxMatrix);
	D3DXMatrixScaling(&auxMatrix, 1.7, 1.7, 1.7);
	D3DXMatrixMultiply(&VenusMatrix, &VenusMatrix, &auxMatrix);
