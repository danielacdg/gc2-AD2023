...
bool GraphicsClass::Render(float rotation){
	...
	D3DXMatrixRotationY(&VenusMatrix, rotation * 1.2);
	D3DXMatrixRotationY(&VenusMatrix, rotation * 1.2);
	D3DXMatrixRotationY(&EarthMatrix, rotation * 1.0);
	D3DXMatrixRotationY(&MoonMatrix, rotation * 1.0);
	D3DXMatrixRotationY(&MartMatrix, rotation * 1.0);
	...
	//marte
	D3DXMatrixTranslation(&auxMatrix, 17, 0, 0);
	...
	D3DXMatrixMultiply(&MercuryMatrix, &MercuryMatrix, &auxMatrix);
	//venus
	D3DXMatrixRotationY(&auxMatrix, rotation * 1.0);
	D3DXMatrixMultiply(&VenusMatrix, &VenusMatrix, &auxMatrix);
	//tierra
	D3DXMatrixRotationY(&auxMatrix, rotation * 0.8);
	D3DXMatrixMultiply(&EarthMatrix, &EarthMatrix, &auxMatrix);
	//luna
	D3DXMatrixTranslation(&auxMatrix, 4, 0, 0);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
	D3DXMatrixRotationY(&auxMatrix, rotation * 0.8);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
	D3DXMatrixTranslation(&auxMatrix, 35, 0, 0);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
	D3DXMatrixRotationY(&auxMatrix, rotation * 0.8);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
	//marte
	...
	D3DXMatrixMultiply(&EarthMatrix, &EarthMatrix, &auxMatrix);
	//luna
	D3DXMatrixScaling(&auxMatrix, 0.6, 0.6, 0.6);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
	//marte
	D3DXMatrixScaling(&auxMatrix, 1.3, 1.3, 1.3);
	D3DXMatrixMultiply(&MartMatrix, &MartMatrix, &auxMatrix);
	...
	result = m_LightShader->Render(m_D3D->GetDeviceContext(), m_Model->GetIndexCount(), VenusMatrix, viewMatrix, projectionMatrix, traMatrix,
		m_Model->GetTexture2(), m_Model->GetTexture2(), m_Light->GetDirection(), m_Light->GetDiffuseColor());
	if (!result)
		return false;
	//Tierra
	//
