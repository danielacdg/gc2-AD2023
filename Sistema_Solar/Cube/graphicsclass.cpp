...
bool GraphicsClass::Render(float rotation){
	...
	D3DXMatrixRotationY(&MercuryMatrix, -rotation * 1.05);
	...
	D3DXMatrixRotationY(&auxMatrix, -rotation * 1);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
	...
	//marte
	D3DXMatrixTranslation(&auxMatrix, 16, 0, 0);
	...
	D3DXMatrixMultiply(&EarthMatrix, &EarthMatrix, &auxMatrix);
	//marte
	D3DXMatrixRotationY(&auxMatrix, -rotation * 0.1);
	D3DXMatrixMultiply(&MartMatrix, &MartMatrix, &auxMatrix);
	...
	D3DXMatrixMultiply(&EarthMatrix, &EarthMatrix, &auxMatrix);
	//marte
	D3DXMatrixScaling(&auxMatrix, 0.9, 0.9, 0.9);
	D3DXMatrixMultiply(&MartMatrix, &MartMatrix, &auxMatrix);
	//luna
	D3DXMatrixScaling(&auxMatrix, 0.7, 0.7, 0.7);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
