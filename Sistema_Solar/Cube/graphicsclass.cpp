...
bool GraphicsClass::Render(float rotation){
	...
	D3DXMatrixRotationY(&VenusMatrix, -rotation * 1.3);
	...
	D3DXMatrixTranslation(&auxMatrix, 26, 0, 0);
	D3DXMatrixMultiply(&EarthMatrix, &EarthMatrix, &auxMatrix);

	D3DXMatrixTranslation(&auxMatrix, 28, 0, 0);
	D3DXMatrixMultiply(&MartMatrix, &MartMatrix, &auxMatrix);

	D3DXMatrixTranslation(&auxMatrix, 65, 0.0, 0.0);
	D3DXMatrixMultiply(&MoonMatrix, &MoonMatrix, &auxMatrix);
	...
	D3DXMatrixScaling(&auxMatrix, 0.4, 0.4, 0.4);
	D3DXMatrixMultiply(&MercuryMatrix, &MercuryMatrix, &auxMatrix);
	...
	D3DXMatrixScaling(&auxMatrix, 0.85, 0.85, 0.85);
	D3DXMatrixMultiply(&MartMatrix, &MartMatrix, &auxMatrix);
