...
bool CDemoTexture::LoadContent()
{
    ...
    hr = ::D3DX11CreateShaderResourceViewFromFile(
        m_pD3DDevice, L"Recursos/texture.jpg", 0, 0,
        &m_ColorMap1, 0);
    if (FAILED(hr)) {
    ...
    hr = ::D3DX11CreateShaderResourceViewFromFile(
        m_pD3DDevice, L"Recursos/water_tx.jpg", 0, 0,
        &m_ColorMap2, 0);
    if (FAILED(hr)) {
...
void CDemoTexture::Render()
{
    ...
    // Clear back buffer
    float color[4] = { 0.0f, 0.10f, 0.25f, 0.1f };
    ...
    m_pD3DContext->PSSetShaderResources(0, 1, &m_ColorMap2);
