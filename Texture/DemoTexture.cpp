...
bool CDemoTexture::LoadContent()
{
    ...
    Vertex vertices[] =
    {
        { XMFLOAT3(  0.4f,  0.5f, 0.0f ), XMFLOAT2(  1.0f,  0.0f  ) },//V1
        { XMFLOAT3(  0.4f, -0.5f, 0.0f ), XMFLOAT2(  1.0f,  1.0f  ) },//V2
        { XMFLOAT3( -0.4f, -0.5f, 0.0f ), XMFLOAT2(  0.0f,  1.0f  ) },//V3

        { XMFLOAT3( -0.4f, -0.5f, 0.0f ), XMFLOAT2(  0.0f,  1.0f  ) },//V3
        { XMFLOAT3( -0.4f,  0.5f, 0.0f ), XMFLOAT2(  0.0f,  0.0f  ) },//V4
        { XMFLOAT3(  0.4f,  0.5f, 0.0f ), XMFLOAT2(  1.0f,  0.0f  ) },//V1
    };
    ...
    // Cargamos la textura
    hr = ::D3DX11CreateShaderResourceViewFromFile(m_pD3DDevice, L"Recursos/Textura.jpg", 0, 0, &m_pColorMap, 0);
    hr = ::D3DX11CreateShaderResourceViewFromFile(m_pD3DDevice, L"Recursos/Humo.jpg", 0, 0, &m_pColorMap2, 0);
    ...
    hr = m_pD3DDevice->CreateSamplerState(&samplerDesc, &m_pColorSampler); 
...
void CDemoTexture::Render()
{
    ...
    m_pD3DContext->PSSetSamplers(0, 1, &m_pColorSampler);
